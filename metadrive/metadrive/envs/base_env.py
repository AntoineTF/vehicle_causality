    ...
    def export_scenarios(
        ...
        for index in scenario_index:
            ...
            while not done:
                ...
                if info["crash"] or info["out_of_road"] or info["crash_vehicle"] or info["crash_object"]:
                    print("##CRASH## for scenario {}".format(index))
                    done = True
                    crash = True
                    info[TerminationState.CRASH] = True
                    count += 1
                else :
                    print("##NO CRASH## for scenario {}".format(index))
        ...
        if info[TerminationState.CRASH] or crash:
            print("info[""crash""] is True! for scenario {}".format(index))
